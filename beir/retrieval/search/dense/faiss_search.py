...
class DenseRetrievalFaissSearch(BaseSearch):
    ...
    def __init__(self, model, corpus_embeddings: np.ndarray=None,faiss_ids: np.ndarray=None, batch_size: int = 128, corpus_chunk_size: int = 50000, use_gpu: bool = False, **kwargs):
        print("okay")
        self.model = model
